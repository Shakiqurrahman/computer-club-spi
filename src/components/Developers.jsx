...
const Developers = () => {
  return (
    <div className=" bg-[#f4f5f8] p-4 py-16 sm:p-20 rounded-[30px]">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        <div className="w-full flex flex-col justify-center items-center bg-white  sm:p-16 px-5 py-14 rounded-[30px] drop-shadow-2xl shadow-md border border-gray-300 hover:border-secondary duration-300 relative overflow-hidden">
        <svg className="absolute top-0 -z-10" viewBox="0 0 500 500" preserveAspectRatio="xMinYMin meet">
          ...
          <p className="text-sm tracking-wider font-semibold uppercase">
            Web developer
          </p>
