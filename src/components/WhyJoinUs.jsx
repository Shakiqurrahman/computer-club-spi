    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="group px-6 py-8 border border-gray-400 rounded-xl flex  flex-col items-center justify-center text-center hover:border-secondary  duration-300">
